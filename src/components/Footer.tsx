      ...
      <div className="bg-gradient-to-r from-[#22c55e] to-[#14b8a6] py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3 text-white">
            ...
            <span className="font-medium">Join our Telegram community for exclusive opportunities!</span>
          </div>
          <a
            href="https://t.me/sprouthr"
            target="_blank"
            rel="noopener noreferrer"
            className="px-6 py-2 rounded-xl bg-white text-[#22c55e] font-semibold text-sm hover:bg-white/90 transition-all flex items-center gap-2"
          >
            <i className="fab fa-telegram-plane"></i> Join Now
          </a>
        </div>
      </div>
